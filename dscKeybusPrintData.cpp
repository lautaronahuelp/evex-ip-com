...
void dscKeybusInterface::printPanelLights(byte panelByte, bool printMessage) {
  if (panelData[panelByte] == 0) stream->print(F("none "));
    ...
    if (bitRead(panelData[panelByte], 0)) stream->print(F("Listo "));
    if (bitRead(panelData[panelByte], 1)) stream->print(F("Armado "));
    if (bitRead(panelData[panelByte], 2)) stream->print(F("Memoria "));
    if (bitRead(panelData[panelByte], 3)) stream->print(F("Anulacion "));
    if (bitRead(panelData[panelByte], 4)) stream->print(F("Falla "));
    if (bitRead(panelData[panelByte], 5)) stream->print(F("Programacion "));
    if (bitRead(panelData[panelByte], 6)) stream->print(F("Fuego "));
    if (bitRead(panelData[panelByte], 7)) stream->print(F("Retroiluminacion "));
  }
...
void dscKeybusInterface::printPanelMessages(byte panelByte) {
  switch (panelData[panelByte]) {
    case 0x01: stream->print(F("Particion lista")); break;
    case 0x02: stream->print(F("Zonas IPA abiertas")); break;
    case 0x03: stream->print(F("Zonas abiertas")); break;
    case 0x04: stream->print(F("Armado: Presente")); break;
    case 0x05: stream->print(F("Armado: Ausente")); break;
    case 0x06: stream->print(F("Armado: Presente sin tiempo de entrada")); break;
    case 0x07: stream->print(F("Fallo al armar")); break;
    case 0x08: stream->print(F("Tiempo de salida en progreso")); break;
    case 0x09: stream->print(F("Armando: Sin tiempo de entrada")); break;
    case 0x0B: stream->print(F("Salida rapida en progreso")); break;
    case 0x0C: stream->print(F("Tiempo de entrada en progreso")); break;
    case 0x0D: stream->print(F("Tiempo de entrada despues de alarma")); break;
    case 0x0E: stream->print(F("Funcion no disponible")); break;
    case 0x10: stream->print(F("Teclado inhibido")); break;
    case 0x11: stream->print(F("Particion en alarma")); break;
    case 0x12: stream->print(F("Chequeo de bateria en progreso")); break;
    case 0x14: stream->print(F("Auto-armado en progreso")); break;
    case 0x15: stream->print(F("Armando con zonas inhibidas")); break;
    case 0x16: stream->print(F("Armado: Ausente sin tiempo de entrada")); break;
    case 0x19: stream->print(F("Desarmado: Alarma en memoria")); break;
    case 0x22: stream->print(F("Desarmado: Cierre reciente")); break;
    case 0x2F: stream->print(F("Keypad LCD test")); break;
    case 0x33: stream->print(F("Salida de comando en progreso")); break;
    case 0x3D: stream->print(F("Desarmado: Alarma en memoria")); break;
    case 0x3E: stream->print(F("Particion desarmada")); break;
    case 0x17: // Keypad blanking with trouble light flashing
    case 0x40: stream->print(F("Keypad blanking")); break;
    case 0x8A: stream->print(F("Activar zonas IPA")); break;
    case 0x8B: stream->print(F("Salida rapida")); break;
    case 0x8E: stream->print(F("Funcion no disponible")); break;
    case 0x8F: stream->print(F("Codigo de acceso invalido")); break;
    case 0x9E: stream->print(F("Ingrese tecla de funcion *")); break;
    case 0x9F: stream->print(F("Ingrese codigo de acceso")); break;
    case 0xA0: stream->print(F("*1: Inhibicion de zonas")); break;
    case 0xA1: stream->print(F("*2: Fallas")); break;
    case 0xA2: stream->print(F("*3: Memoria de alarma")); break;
    case 0xA3: stream->print(F("Chime habilitado")); break;
    case 0xA4: stream->print(F("Chime deshabilitado")); break;
    case 0xA5: stream->print(F("Ingrese codigo maestro")); break;
    case 0xA6: stream->print(F("*5: Codigos de acceso")); break;
    case 0xA7: stream->print(F("*5: Ingrese codigo de 4 digitos")); break;
    case 0xA9: stream->print(F("*6: Funciones de usuario")); break;
    case 0xAA: stream->print(F("*6: Hora y fecha")); break;
    case 0xAB: stream->print(F("*6: Hora de auto-armado")); break;
    case 0xAC: stream->print(F("*6: Auto-armado habilitado")); break;
    case 0xAD: stream->print(F("*6: Auto-armado deshabilitado")); break;
    case 0xAF: stream->print(F("*6: Prueba de sistema")); break;
    case 0xB0: stream->print(F("*6: Habilitar DLS")); break;
    case 0xB2:
    case 0xB3: stream->print(F("*7: Salida de comando")); break;
    case 0xB7: stream->print(F("Ingrese codigo de instalador")); break;
    case 0xB8: stream->print(F("Ingrese tecla de funcion * mientras esta armado")); break;
    case 0xB9: stream->print(F("*2: Submenu tamper de zonas")); break;
    case 0xBA: stream->print(F("*2: Zonas con baja bateria")); break;
    case 0xBC: stream->print(F("*5: Ingrese codigo de 6 digitos")); break;
    case 0xBF: stream->print(F("*6: Seleccion dia de autoarmado")); break;
    case 0xC6: stream->print(F("*2: Submenu falla de zona")); break;
    //case 0xC7: stream->print(F("Partition not available")); break;
    case 0xC8: stream->print(F("*2: Submenu requiere service")); break;
    case 0xCD: stream->print(F("Descarga en progreso")); break;
    case 0xCE: stream->print(F("Active camera monitor selection")); break;
    case 0xD0: stream->print(F("*2: Teclados con baja bateria")); break;
    case 0xD1: stream->print(F("*2: Controles con baja bateria")); break;
    case 0xD4: stream->print(F("*2: Zonas con interferencia RF")); break;
    case 0xE4: stream->print(F("*8: Direccion de programacion, 3 digitos")); decimalInput = false; break;
    case 0xE5: stream->print(F("Asignacion slot de teclado")); break;
    case 0xE6: stream->print(F("Ingrese: 2 digitos")); break;
    case 0xE7: stream->print(F("Ingrese: 3 digitos")); decimalInput = true; break;
    case 0xE8: stream->print(F("Ingrese: 4 digitos")); break;
    case 0xE9: stream->print(F("Ingrese: 5 digitos")); break;
    case 0xEA: stream->print(F("Ingrese HEX: 2 digitos")); break;
    case 0xEB: stream->print(F("Ingrese HEX: 4 digitos")); break;
    case 0xEC: stream->print(F("Ingrese HEX: 6 digitos")); break;
    case 0xED: stream->print(F("Ingrese HEX: 32 digitos")); break;
    case 0xEE: stream->print(F("Ingrese: 1 opcion por zona")); break;
    case 0xEF: stream->print(F("Campo de supervision de modulos")); break;
    case 0xF0: stream->print(F("Tecla de funcion 1")); break;
    case 0xF1: stream->print(F("Tecla de funcion 2")); break;
    case 0xF2: stream->print(F("Tecla de funcion 3")); break;
    case 0xF3: stream->print(F("Tecla de funcion 4")); break;
    case 0xF4: stream->print(F("Tecla de funcion 5")); break;
    case 0xF5: stream->print(F("Prueba de ubicacion modulo inalambrico")); break;
    case 0xF6: stream->print(F("Activar dispositivo para prueba")); break;
    case 0xF7: stream->print(F("*8: Direccion de programacion, 2 digitos")); decimalInput = false; break;
    case 0xF8: stream->print(F("Programacion de teclado")); break;
    case 0xFA: stream->print(F("Ingrese: 6 digitos")); break;
    default:
...
void dscKeybusInterface::printPanelStatus0(byte panelByte) {
  ...
  switch (panelData[panelByte]) {
    ...
    case 0x49: stream->print(F("Alarma de coaccion")); break;
    case 0x4A: stream->print(F("Desarmado: Alarma en memoria")); break;
    case 0x4B: stream->print(F("Alarma cierre reciente")); break;
    case 0x4C: stream->print(F("Alarma de supervision expansor de zonas")); break;
    case 0x4D: stream->print(F("Restauracion de supervision expansor de zonas")); break;
    case 0x4E: stream->print(F("Alarma tecla Fuego")); break;
    case 0x4F: stream->print(F("Alarma tecla Auxiliar")); break;
    case 0x50: stream->print(F("Alarma tecla Panico")); break;
    case 0x51: stream->print(F("Alarma entrada PGM2")); break;
    case 0x52: stream->print(F("Restauracion tecla Fuego")); break;
    case 0x53: stream->print(F("Restauracion tecla Auxiliar")); break;
    case 0x54: stream->print(F("Restauracion tecla Panico")); break;
    case 0x55: stream->print(F("Restauracion entrada PGM2")); break;
    // 0x56 - 0x75: Zone tamper, zones 1-32
    // 0x76 - 0x95: Zone tamper restored, zones 1-32
    case 0x98: stream->print(F("Teclado inhibido")); break;
    // 0x99 - 0xBD: Armed: Access codes 1-34, 40-42
    case 0xBE: stream->print(F("Armado: Parcial")); break;
    case 0xBF: stream->print(F("Armado: Especial")); break;
    // 0xC0 - 0xE4: Disarmed: Access codes 1-34, 40-42
    case 0xE5: stream->print(F("Auto-armado cancelado")); break;
    case 0xE6: stream->print(F("Desarmado: Especial")); break;
    case 0xE7: stream->print(F("Falla bateria panel")); break;
    case 0xE8: stream->print(F("Falla 220v panel")); break;
    case 0xE9: stream->print(F("Falla de sirena")); break;
    case 0xEA: stream->print(F("Falla zona de fuego")); break;
    case 0xEB: stream->print(F("Falla 12v panel")); break;
    case 0xEC: stream->print(F("Falla linea telefonica")); break;
    case 0xEF: stream->print(F("Restauracion bateria panel")); break;
    case 0xF0: stream->print(F("Restauracion 220v panel")); break;
    case 0xF1: stream->print(F("Restauracion de sirema")); break;
    case 0xF2: stream->print(F("Restauracion zona de fuego")); break;
    case 0xF3: stream->print(F("Restauracion 12v panel")); break;
    case 0xF4: stream->print(F("Restauracion linea telefonica")); break;
    case 0xF7: stream->print(F("Falla de comunicacion telefono 1")); break;
    case 0xF8: stream->print(F("Falla de comunicacion telefono 2")); break;
    case 0xF9: stream->print(F("Memoria de alarma 75% llena")); break;  //75% full since last DLS upload
    case 0xFA: stream->print(F("Ingreso DLS")); break;
    case 0xFB: stream->print(F("Salida DLS")); break;
    case 0xFE: stream->print(F("Prueba periodica")); break;
    case 0xFF: stream->print(F("Prueba de sistema")); break;
  ...
  if (panelData[panelByte] >= 0x29 && panelData[panelByte] <= 0x48) {
    stream->print("Alarma de zona restaurada: ");
  ...
  if (panelData[panelByte] >= 0x76 && panelData[panelByte] <= 0x95) {
    stream->print("Tamper de zona restaurado: ");
...
void dscKeybusInterface::printPanelStatus1(byte panelByte) {
  switch (panelData[panelByte]) {
     ...
     *  Byte 0   1    2        3        4        5        6        7        8
     */
    case 0x03: stream->print(F("Alarma zonas cruzadas")); return;
    case 0x04: stream->print(F("Alarma de delincuencia")); return;
    case 0x05: stream->print(F("Tarde para cerrar")); return;
    // 0x24 - 0x28: Access codes 33-34, 40-42
    case 0x29: stream->print(F("DLS forzado")); return;
    case 0x2B: stream->print(F("Armado: Auto-armado")); return;
    ...
    case 0xAC: stream->print(F("Salida de programacion")); return;
    case 0xAD: stream->print(F("Ingreso de programacion")); return;
    case 0xAE: stream->print(F("Fin prueba de paseo")); return;
    case 0xAF: stream->print(F("Inicio prueba de paseo")); return;
    // 0xB0 - 0xCF: Zones bypassed, zones 1-32
    case 0xD0: stream->print(F("Salida de comando 4")); return;
    case 0xD1: stream->print(F("Prealerta de falla de salida")); return;
    case 0xD2: stream->print(F("Armado: Tiempo de entrada")); return;
  ...
  if (panelData[panelByte] >= 0x2C && panelData[panelByte] <= 0x4B) {
    stream->print(F("Restauracion bateria de zona: "));
  ...
  if (panelData[panelByte] >= 0x4C && panelData[panelByte] <= 0x6B) {
    stream->print(F("Falla bateria zona: "));
  ...
  if (panelData[panelByte] >= 0x6C && panelData[panelByte] <= 0x8B) {
    stream->print(F("Restauracion falla de zona: "));
...
void dscKeybusInterface::printPanelStatus2(byte panelByte) {
  switch (panelData[panelByte]) {
     ...
     *  Byte 0   1    2        3        4        5        6        7        8
     */
    case 0x2A: stream->print(F("Salida rapida")); return;
    case 0x63: stream->print(F("Restauracion falla de keybus")); return;
    case 0x64: stream->print(F("Falla de keybus")); return;
    case 0x66: stream->print(F("*1: Inhibicion de zona")); return;
    // 0x67 - 0x69: *7: Command output 1-3
    case 0x8C: stream->print(F("Arranque en frio")); return;
    case 0x8D: stream->print(F("Arranque en caliente")); return;
    case 0x8E: stream->print(F("Restauracion panel a fabrica")); return;
    case 0x91: stream->print(F("Swinger shutdown")); return;
    case 0x93: stream->print(F("Desarmado: Keyswitch")); return;
    case 0x96: stream->print(F("Armado: Keyswitch")); return;
    case 0x97: stream->print(F("Armado: Ausente de teclado")); return;
    case 0x98: stream->print(F("Armado: Armado rapido")); return;
    case 0x99: stream->print(F("Activacion zonas IPA")); return;
    case 0x9A: stream->print(F("Armado: Presente")); return;
    case 0x9B: stream->print(F("Armado: Ausente")); return;
    case 0x9C: stream->print(F("Armado: Sin tiempo de entrada")); return;
    ...
    case 0xFF: stream->print(F("Falla expansor de zonas: 1")); return;
  }
  ...
  if (panelData[panelByte] >= 0x67 && panelData[panelByte] <= 0x69) {
    stream->print(F("Salida de comando: "));
  ...
  if (panelData[panelByte] >= 0xE9 && panelData[panelByte] <= 0xF0) {
    stream->print(F("Restauracion teclado: Slot "));
  ...
  if (panelData[panelByte] >= 0xF1 && panelData[panelByte] <= 0xF8) {
    stream->print(F("Falla teclado: Slot "));
  ...
  if (panelData[panelByte] >= 0xF9 && panelData[panelByte] <= 0xFE) {
    stream->print(F("Restauracion expansor de zonas: "));
...
void dscKeybusInterface::printPanelStatus3(byte panelByte) {
  switch (panelData[panelByte]) {
    case 0x05: stream->print(F("PC/RF5132: Restauracion de supervision")); return;
    case 0x06: stream->print(F("PC/RF5132: Falla de supervision")); return;
    case 0x09: stream->print(F("PC5204: Restauracion de supervision")); return;
    case 0x0A: stream->print(F("PC5204: Falla de supervision")); return;
    case 0x17: stream->print(F("Restauracion expansor de zonas: 7")); return;
    case 0x18: stream->print(F("Falla expansor de zonas: 7")); return;
    ...
    case 0x41: stream->print(F("PC/RF5132: Restauracion de tamper")); return;
    case 0x42: stream->print(F("PC/RF5132: Tamper")); return;
    case 0x43: stream->print(F("PC5208: Restauracion de tamper")); return;
    case 0x44: stream->print(F("PC5208: Tamper")); return;
    case 0x45: stream->print(F("PC5204: Restauracion de tamper")); return;
    case 0x46: stream->print(F("PC5204: Tamper")); return;
    case 0x51: stream->print(F("Restauracion tamper expansor de zonas: 7")); return;
    case 0x52: stream->print(F("Tamper expansor de zonas: 7")); return;
    case 0xB3: stream->print(F("PC5204: Restauracion de baeria")); return;
    case 0xB4: stream->print(F("PC5204: Falla de bateria")); return;
    case 0xB5: stream->print(F("PC5204: Restauracion falla 12v")); return;
    case 0xB6: stream->print(F("PC5204: Falla 12v")); return;
    case 0xB7: stream->print(F("PC5204: Restauracion salida 1")); return;
    case 0xB8: stream->print(F("PC5204: Falla salida 1")); return;
    case 0xFF: stream->print(F("Estado extendido")); return;
  }
  ...
  if (panelData[panelByte] <= 0x04) {
    stream->print(F("Falla expansor de zonas: "));
  ...
  if (panelData[panelByte] >= 0x25 && panelData[panelByte] <= 0x2C) {
    stream->print(F("Restauracion tamper de teclado: "));
  ...
  if (panelData[panelByte] >= 0x2D && panelData[panelByte] <= 0x34) {
    stream->print(F("Tamper de teclado: "));
  ...
  if (panelData[panelByte] >= 0x35 && panelData[panelByte] <= 0x3A) {
    stream->print(F("Restauracion tamper expansor de zonas: "));
  ...
  if (panelData[panelByte] >= 0x3B && panelData[panelByte] <= 0x40) {
    stream->print(F("Tamper expansor de zonas: "));
...
void dscKeybusInterface::printPanelStatus4(byte panelByte) {
  switch (panelData[panelByte]) {
    case 0x86: stream->print(F("Prueba periodica con problema")); return;
    case 0x87: stream->print(F("Falla al salir")); return;
    case 0x89: stream->print(F("Cancelacion de alarma")); return;
  }

  if (panelData[panelByte] <= 0x1F) {
    stream->print("Alarma zona: ");
    printNumberOffset(panelByte, 33);
  }

  else if (panelData[panelByte] >= 0x20 && panelData[panelByte] <= 0x3F) {
    stream->print("Restauracion zona: ");
    ...
    stream->print("Restauracion tamper de zona: ");
...
void dscKeybusInterface::printPanelStatus14(byte panelByte) {
  ...
  switch (panelData[panelByte]) {
    case 0xC0: stream->print(F("Falla comunicacion TLink ")); return;
    case 0xC2: stream->print(F("Falla red TLink")); return;
    case 0xC4: stream->print(F("Falla receptor TLink")); return;
    case 0xC5: stream->print(F("Restauracion receptor TLink")); return;
  }
  #endif
...
void dscKeybusInterface::printPanelStatus16(byte panelByte) {
  switch (panelData[panelByte]) {
    case 0x80: stream->print(F("Reconocimiento de falla")); return;
    case 0x81: stream->print(F("Falla supervision RF")); return;
    case 0x82: stream->print(F("Restauracion supervision RF")); return;
  }
...
void dscKeybusInterface::printPanelStatus1B(byte panelByte) {
  switch (panelData[panelByte]) {
    case 0xF1: stream->print(F("Reinicio de sistema")); return;
  }
...
void dscKeybusInterface::printPanel_0x0A_0F() {
  ...
  if (!zoneLights) stream->print(F("ninguna"));
}
...
void dscKeybusInterface::printPanel_0x11() {
  stream->print(F("Consulta de supervision de modulos"));
}
...
void dscKeybusInterface::printPanel_0x16() {
  ...
  if (panelData[2] == 0x0E) {
    ...
    // Panel version
    stream->print(F("Version panel: v"));
    stream->print(panelData[3] >> 4);
    stream->print(".");
    stream->print(panelData[3] & 0x0F);

    // Zone wiring
    stream->print(F(" | Cableado de zonas: "));
...
void dscKeybusInterface::printPanel_0x1C() {
  stream->print(F("Verificando teclas Fuego/Auxiliar/Panico"));
}
...
void dscKeybusInterface::printPanel_0x22_28_33_39() {
  ...
  stream->print(F("Consulta de expansores de zonas: "));
...
void dscKeybusInterface::printPanel_0x27() {
  ...
  stream->print(F(" | Zonas 1-8 abiertas: "));
...
void dscKeybusInterface::printPanel_0x2D() {
  ...
  stream->print(F(" | Zonas 9-16 abiertas: "));
...
void dscKeybusInterface::printPanel_0x34() {
  ...
  stream->print(F(" | Zonas 17-24 abiertas: "));
...
void dscKeybusInterface::printPanel_0x3E() {
  ...
  stream->print(F(" | Zonas 25-32 abiertas: "));
...
void dscKeybusInterface::printPanel_0x41() {
  stream->print(F("Consulta modulos inalambricos"));
}
...
void dscKeybusInterface::printPanel_0x4C() {
  stream->print(F("Consulta tamper de modulos"));
}
...
void dscKeybusInterface::printPanel_0x57() {
  stream->print(F("Consulta controles inalambricos"));
}
...
void dscKeybusInterface::printPanel_0x58() {
  stream->print(F("Consulta estado de modulos"));
}
...
void dscKeybusInterface::printPanel_0x5D_63() {
  ...
  stream->print(F("| Zonas 1-32 centelleando: "));
  printPanelZones(3, 1);
}
...
void dscKeybusInterface::printPanel_0x70() {
  stream->print(F("Consulta datos de LCD"));
}
...
void dscKeybusInterface::printPanel_0x87() {
  stream->print(F("Salidas PGM activadas: "));
  if (panelData[2] == 0 && panelData[3] == 0) stream->print(F("ninguna "));
  else {
  ...
  if (panelData[3] & 0x04) stream->print(F("| Medianoche "));
  if (panelData[3] & 0x08) stream->print(F("| Checkeo de bateria"));
}
...
void dscKeybusInterface::printPanel_0x8D() {
  #if !defined(__AVR__)
  stream->print(F("Ingreso programacion de modulo: "));
...
void dscKeybusInterface::printPanel_0x94() {
  #if !defined(__AVR__)
  stream->print(F("Solicitud programacion de modulo: "));
  printModuleProgramming(panelData[2], panelData[3]);
  #else
  stream->print(F("Solicitud programacion de modulo"));
  #endif
...
void dscKeybusInterface::printPanel_0xB1() {
  stream->print(F("Zonas habilitadas 1-32 | Particion 1: "));
  printPanelZones(2, 1);

  stream->print(F("| Particion 2: "));
  printPanelZones(6, 1);
}
...
void dscKeybusInterface::printPanel_0xBB() {
  stream->print(F("Sirena: "));
  if (bitRead(panelData[2], 5)) stream->print(F("encendida"));
  else stream->print(F("apagada"));
}
...
void dscKeybusInterface::printPanel_0xC3() {
  if (panelData[3] == 0xFF) {
    stream->print(F("TLM: "));
    if (panelData[2] & 0x10) stream->print(F("problema/intento"));
    else stream->print(F("disponible/desabilitado"));

    if (panelData[2] & 0x08) stream->print(F(" | Intento llamada comunicador"));
    if (panelData[2] & 0x20) stream->print(F(" | Teclado inhibido"));
  }
  else printUnknownData();
}
...
void dscKeybusInterface::printPanel_0xD5() {
  stream->print(F("Consulta zonas de teclado"));
}
...
void dscKeybusInterface::printPanel_0xE6_0x08_0A_0C_0E() {
  ...
  stream->print(F("Consulta expansor de zonas: "));
  stream->print(expander);
}
...
void dscKeybusInterface::printPanel_0xE6_0x09() {
  stream->print(F("Zonas 33-40 abiertas: "));
...
void dscKeybusInterface::printPanel_0xE6_0x0B() {
  stream->print(F("Zonas 41-48 abiertas: "));
...
void dscKeybusInterface::printPanel_0xE6_0x0D() {
  stream->print(F("Zonas 49-56 abiertas: "));
...
void dscKeybusInterface::printPanel_0xE6_0x0F() {
  stream->print(F("Zonas 57-64 abiertas: "));
...
void dscKeybusInterface::printPanel_0xE6_0x18() {
  ...
  stream->print(F("| Zonas 33-64 centelleando: "));
  printPanelZones(5, 33);
}
...
void dscKeybusInterface::printPanel_0xE6_0x1A() {
  ...
  stream->print(F("Particiones en alarma: "));
  printPanelBitNumbers(4, 1);

  if (panelData[6] & 0x08) stream->print(F("| Perdida de hora y fecha "));
  if (panelData[6] & 0x10) stream->print(F("| Falla 220v "));
  if (panelData[6] & 0x40) stream->print(F("| Falla de comunicacion "));
  if (panelData[6] & 0x80) stream->print(F("| Alarma de fuego "));
}
...
void dscKeybusInterface::printPanel_0xE6_0x2B() {
  ...
  stream->print(F("| Zonas habilitadas 1-32: "));
  printPanelZones(4, 1);
}
...
void dscKeybusInterface::printPanel_0xE6_0x2C() {
  ...
  stream->print(F("| Zonas habilitadas 33-64: "));
...
void dscKeybusInterface::printModule_0xBB() {
  stream->print(F("[Teclado] Alarma de Fuego"));
}
...
void dscKeybusInterface::printModule_0xDD() {
  stream->print(F("[Teclado] Alarma Auxiliar"));
}
...
void dscKeybusInterface::printModule_0xEE() {
  stream->print(F("[Teclado] Alarma de Panico"));
}
...
void dscKeybusInterface::printModule_Status() {
  ...
  if (moduleCmd == 0x1B && moduleData[4] != 0xFF) {
    ...
    stream->print(F("Teclado en particion: "));
    printModuleSlots(1, 4, 4, 0x80, 0, 1, 0, true);
    stream->print(F("desocupado"));
    printedMessage = true;
  }
  else {
    ...
    if ((moduleData[4] & 0xF0) != 0xF0 || (moduleByteCount > 6 && (moduleData[7] & 0xF0) != 0xF0)) {
      if (printedMessage) stream->print("| ");
      stream->print(F("Notificacion expansor de zonas: "));
      printedMessage = true;
    ...
    if ((moduleData[4] & 0x01) == 0) {
      if (printedMessage) stream->print("| ");
      stream->print(F("Notificacion tamper de modulo "));
      printedMessage = true;
    }
    ...
    if ((moduleData[4] & 0x08) == 0) {
      if (printedMessage) stream->print("| ");
      stream->print(F("Notificacion bateria modulo inalambrico "));
      printedMessage = true;
    }
  }
  ...
  if ((moduleData[5] & 0x02) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Notificacion inalambrica "));
    printedMessage = true;
  }
  ...
  if ((moduleData[5] & 0x04) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Notificacion zona de teclado "));
    printedMessage = true;
  }
  ...
  if ((moduleData[5] & 0x20) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Notificacion estado de modulo "));
    printedMessage = true;
  }
  ...
  if ((moduleData[5] & 0x40) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Notificacion control inalambrico "));
    printedMessage = true;
  }
  ...
  if (moduleByteCount > 6 && (moduleData[7] & 0x08) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Notificacion teclado "));
    printedMessage = true;
  }

  if (moduleByteCount > 6 && (moduleData[6] & 0x80) == 0 && (moduleData[6] & 0x60) != 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Emision chime "));
    printedMessage = true;
  }

  if (moduleByteCount > 6 && (moduleData[6] & 0x60) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Emision etiqueta de zona "));
    printedMessage = true;
  }
...
void dscKeybusInterface::printModule_0x4C() {
  ...
  if (printModuleSlots(255, 2, 5, 0xC0, 0, 4, 0)) {
    stream->print(F("Tamper de teclado: Slot "));
  ...
  if (printModuleSlots(255, 2, 5, 0xF0, 0, 4, 0x0C)) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Restauracion tamper de teclado: Slot "));
  ...
  if (printModuleSlots(255, 6, 8, 0xC0, 0, 4, 0) || (moduleByteCount > 13 && (moduleData[13] & 0xC0) == 0)) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Tamper de modulo: Slot "));
  ...
  if (printModuleSlots(255, 6, 8, 0xF0, 0, 4, 0x0C) || (moduleByteCount > 13 && (moduleData[13] & 0xF0) == 0xC0)) {
    if (printedMessage) stream->print("| ");
    stream->print(F("Restauracion tamper de modulo: Slot "));
  ...
  if ((moduleData[9] & 0xF0) == 0xC0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("RF5132: Restauracion de tamper "));
    printedMessage = true;
  }
  ...
  if ((moduleData[9] & 0x0F) == 0x0C) {
    if (printedMessage) stream->print("| ");
    stream->print(F("PC5208: Restauracion de tamper "));
    printedMessage = true;
  }
  ...
  if ((moduleData[10] & 0xF0) == 0xC0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("PC5204: Restauracion de tamper "));
    printedMessage = true;
  }
}
...
void dscKeybusInterface::printModule_0x57() {
  ...
  if (printModuleSlots(255, 2, 5, 0xC0, 0, 2, 0x02, true)) {
    stream->print(F("Falla bateria control inalambrico: "));
  ...
  if (printModuleSlots(255, 2, 5, 0xC0, 0, 2, 0x01, true)) {
    ...
    stream->print(F("Restauracion bateria control inalambrico: "));
...
void dscKeybusInterface::printModule_0x58() {
  ...
  if ((moduleData[2] & 0x03) == 0) {
    stream->print(F("PC5204: Restauracion bateria "));
    printedMessage = true;
  }

  if ((moduleData[2] & 0x0C) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("PC5204: Falla bateria "));
    printedMessage = true;
  }

  if ((moduleData[2] & 0x30) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("PC5204: Restauracion 220v "));
    printedMessage = true;
  }

  if ((moduleData[2] & 0xC0) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("PC5204: Falla 220v "));
    printedMessage = true;
  }

  if ((moduleData[3] & 0x03) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("PC5204: Restauracion salida 1 "));
    printedMessage = true;
  }

  if ((moduleData[3] & 0x0C) == 0) {
    if (printedMessage) stream->print("| ");
    stream->print(F("PC5204: Falla salida 1 "));
    printedMessage = true;
  }
...
void dscKeybusInterface::printModule_0x94() {
  stream->print(F("Respuesta programacion de modulo"));
}
...
void dscKeybusInterface::printModule_0xD5() {
  ...
  for (byte moduleByte = 2; moduleByte <= 9; moduleByte++) {
    ...
    if (slotData < 0xFF) {
      ...
      if ((slotData & 0x03) == 0x03 && (slotData & 0x30) == 0) stream->print(F(": Zona abierta"));
      if ((slotData & 0x03) == 0 && (slotData & 0x30) == 0x30) stream->print(F(": Zona cerrada"));
    }
  }
}
  ...
  for (byte testByte = startByte; testByte <= endByte; testByte++) {
    ...
    if (moduleData[testByte] != 0xFF) {
        if (hideKeypadDigits && moduleData[testByte] <= 0x27) {
            stream->print(F("[Digito] "));
        }
        else {
          stream->print(F("Particion "));
          printNumberSpace(partitionNumber);
          stream->print(F("Tecla: "));
...
void dscKeybusInterface::printModule_KeyCodes(byte keyByte) {
  switch (moduleData[keyByte]) {
    ...
    case 0x46: stream->print(F("Desarmado con control inalambrico ")); break; //isn't send if wls keys uses access codes 17-32 is enabled
    case 0x52: stream->print(F("Identified voice prompt help ")); break;
    case 0x6E: stream->print(F("Armado ausente global ")); break;
    case 0x70: stream->print(F("Salida comando 3 ")); break;
    case 0x7A: stream->print(F("Programacion de fecha y hora ")); break;
    case 0x75: stream->print(F("Ingreso *1/*2/*3 ? ")); break;
    case 0x82: stream->print(F("Ingresar ")); break;
    case 0x87: stream->print(F("Flecha derecha ")); break;
    case 0x88: stream->print(F("Flecha izquierda ")); break;
    ...
    case 0xA5: stream->print(F("Recibir datos ")); break;
    case 0xAA: stream->print(F("Ingresar datos ")); break;
    case 0xAF: stream->print(F("Armado: Presente ")); break;
    case 0xB1: stream->print(F("Armado: Ausente ")); break;
    case 0xB6: stream->print(F("Armado: Sin tiempo de entrada ")); break;
    case 0xBB: stream->print(F("Configuracion de chime ")); break;
    case 0xBC: stream->print(F("*6 Prueba de sistema ")); break;
    case 0xC3: stream->print(F("*1 Inhibicion de zonas ")); break;
    case 0xC4: stream->print(F("*2 Menu de fallas ")); break;
    case 0xC9: stream->print(F("*3 Memoria de alarma ")); break;
    case 0xCE: stream->print(F("*5 Programacion ")); break;
    case 0xD0: stream->print(F("*6 Programacion ")); break;
    case 0xD5: stream->print(F("Salida de comando 1 ")); break;
    case 0xDA: stream->print(F("Reset / Salida de comando 2 ")); break;
    case 0xDF: stream->print(F("Armado presente global ")); break;
    case 0xE1: stream->print(F("Salida rapida ")); break;
    case 0xE6: stream->print(F("Armar zonas presente/ausente ")); break;
    case 0xEB: stream->print(F("LCD pixel test ")); break;
    case 0xEC: stream->print(F("Salida de comando 4 ")); break;
    case 0xF2: stream->print(F("Desarmado global ")); break;  // Possible overlap with "General voice prompt help"
    case 0xF7: stream->print(F("Navegacion de menu ")); break;
    default: stream->print(moduleData[keyByte],HEX); break;
  }
}
...
void dscKeybusInterface::printModule_Expander() {
  ...
  stream->print(F("Expansor de zona: "));
  switch (moduleCmd) {
  ...
  if (moduleData[startByte] != moduleData[startByte + 1] || moduleData[startByte + 2] != moduleData[startByte + 3]) {
    stream->print(F("| Cambio en zonas: "));
      ...
      for (byte zoneMask = 0x03; zoneMask != 0; zoneMask <<= 2) {
        if ((moduleData[zoneByte] & zoneMask) != (moduleData[zoneByte + 1] & zoneMask)) {
          ...
          switch ((moduleData[zoneByte] & zoneMask) >> zoneMaskShift) {
            case 0: stream->print(F("abierta ")); break;
            case 1: stream->print(F("cerrada ")); break;
            case 2: stream->print(F("tamper ")); break;
            case 3: stream->print(F("abierta (D/EOL) ")); break;
          }
        }
        zoneNumber++;
        zoneMaskShift += 2;
...
void dscKeybusInterface::printModuleProgramming(byte panelByte2, byte panelByte3) {
  switch (panelByte2) {
    ...
    case 0x31: stream->print(F("*5 usuario")); break; //*5 access codes verified on pc1832 and pc5020
    default: stream->print("Unknown data");
  }
  stream->print(" | ");
...
void dscKeybusInterface::printPanelPartitionStatus(byte startPartition, byte startByte, byte endByte) {
  ...
  for (byte statusByte = startByte; statusByte <= endByte; statusByte += 2) {
    ...
    if (panelData[statusByte] == 0 || panelData[statusByte] == 0xC7 || panelData[statusByte] == 0xFF) stream->print(F("deshabilitada"));
...
void dscKeybusInterface::printPanelAccessCode(byte dscCode, bool accessCodeIncrease) {
  ...
  stream->print(F("Codigo "));
  

  switch (dscCode) {
    case 40: stream->print(F("Maestro ")); break;
    default: stream->print(F("de Acceso ")); break;
  }
...
void dscKeybusInterface::printPanelTone(byte panelByte) {
  ...
  if (panelData[panelByte] == 0) {
    stream->print(F("ninguno"));
    return;
  }

  if ((panelData[panelByte] & 0x80) == 0x80) {
    stream->print(F("tono constante "));
    printedMessage = true;
  }
...
bool dscKeybusInterface::printPanelZones(byte inputByte, byte startZone) {
  ...
  if (!zonesEnabled && panelData[0] != 0x0A && panelData[0] != 0x0F) stream->print(F("ninguna"));
...
void dscKeybusInterface::printStatusLights() {
  stream->print(F("Luces de estado: "));
}


void dscKeybusInterface::printZoneLights(bool lowerRange) {
  if (lowerRange) stream->print(F(" | Luces zonas 1-32: "));
  else  stream->print(F(" | Luces zonas 33-64: "));
}


void dscKeybusInterface::printStatusLightsFlashing() {
  stream->print(F("| Luces de estado centelleando: "));
}
...
void dscKeybusInterface::printPanelBitNumbers(byte panelByte, byte startNumber, byte startBit, byte stopBit, bool printNone) {
  if (printNone && panelData[panelByte] == 0) stream->print(F("ninguna "));
  else {
    byte bitCount = 0;
